        ...
        <div id="publications" class="page">
            <div class="page-container">
                ...
                <div class="pagecontents">
                    ...
                    <?php if (count($types)>0 && ot_get_option('show_pub_filter')=="on"): ?>
                                ...
                                <?php if (function_exists('ot_get_option')): ?>
                                    ...
                                    <?php if (ot_get_option('pub_filter') == 'inline'): ?>
                                        ...
                                        <div class="col-md-6" id="miu-filter">
                                            <span class="btn btn-default btn-sm active" value="all"><?php _e( 'All types', 'faculty' ); ?>
                                                (
                                                    <?php 
                                            ...
                                            <?php foreach ($types as $type): ?>
                                                <span class="btn btn-default btn-sm" value="<?php echo $type->slug ?>"><?php echo $type->name; ?>
                                                (
                                                <?php 
                                                echo count( get_posts( array( 
                                                    'post_type' => 'publications', 
                                    ...
                                    <?php else: ?>
                                        <div class="col-md-6">
                                            <select id="cd-dropdown" name="cd-dropdown" class="cd-select">
                                                <option class="filter" value="all" <?php if (ot_get_option('pub_filter_preset')==''){echo"selected";} ?>><?php _e( 'All types', 'faculty' ); ?>
                                                    (
                                                    <?php 
                                                    echo count( get_posts( array( 
                                                        'post_type' => 'publications',
                                                ...
                                                <?php foreach ($types as $type): ?>
                                                    <option class="filter" value="<?php echo $type->slug ?>" <?php if ($type->slug == ot_get_option('pub_filter_preset')){echo"selected";} ?>><?php echo $type->name; ?>
                                                    (
                                                    <?php 
                                                    echo count( get_posts( array( 
                                                        'post_type' => 'publications', 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pitems">
                                        <?php
                                        //setup new WP_Query
                                        if(ot_get_option('override_order')=='on'){
                                            $arg= array(
                                                'posts_per_page'    =>    -1,
                                                'post_type'         =>    'publications',
                                                'meta_key' => 'fac_pub_year',
                                                'order' => ot_get_option('pub_order')
                                            );
                                        }else{
                                            $arg = array(
                                                'posts_per_page'    =>    -1,
