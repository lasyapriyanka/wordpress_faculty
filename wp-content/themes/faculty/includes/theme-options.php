...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        'id'          => 'cv_file',
        'label'       => __('CV file','faculty'),
        'desc'        => __('Upload your CV file','faculty'),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'general',
        'rows'        => '',
      ...
      array(
        ...
        array(
            'id'          => 'side-footer-layout',
            'label'       => __('Sidebar footer layout','faculty'),
            'desc'        => '',
            'std'         => 'stick-to-bottom',
            'type'        => 'radio',
            'section'     => 'etc',
            ...
            'choices'     => array( 
                array(
                    ...
                    'label'       => __('Stick to bottom','faculty'),
                    'src'         => ''
                ),
                array(
                    'value'       => 'after-the-nav',
                    'label'       => __('Right after navigation menu','faculty'),
                    'src'         => ''
                )
            )
        )
