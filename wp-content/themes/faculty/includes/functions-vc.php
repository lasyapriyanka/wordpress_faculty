 ...
 class Owlab_vc_extend {
    ...
    */
    ...
    public function render_wrapper ($atts, $content = null) {
		...
		$css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, get_row_css_class().$el_class);
    ...
    public function render_project_single ($atts, $content = null) {
		...
		$output ='<li class="'.$css_class.'"><div class="row">';
		$output .= "\n\t\t\t\t" . '<div class="col-sm-6 col-md-3"><div class="image"><img src='.$img_link.' alt="'.$project_title.'" class="img-responsive">';
		$output .='<div class="imageoverlay"><i class="fa fa-search"></i></div></div></div>';
...
$shortcodes = array(
	...
	'title' => array(
		...
		"base" => "vc_title",
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/vc-title.png",
		...
		"params" => array(
			...
			array(
				...
				"value" => array(__('Align center', "faculty") => "text-center", __('Align left', "faculty") => "text-left", __('Align right', "faculty") => "text-right"),
	...
	'wrapper'	=>	array(
		...
		"category" 		=> __("faculty", "faculty"),
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/row.png",
	...
	'position'	=>	array(
		...
		"category" 		=> __("faculty", "faculty"),
	    "icon" => get_stylesheet_directory_uri()."/img/vc_icons/position.png",
	    "params" => array(
	         array(
	          "type" => "textfield",
	...
	'education' => array(
		...
		"category" 		=> __("faculty", "faculty"),
	    "show_settings_on_create" => false,
	    "icon" => get_stylesheet_directory_uri()."/img/vc_icons/education.png",
	    "params" => array(
	         array(
	          "type" => "textfield",
	          "heading" => __("Widget title", "faculty"),
	...
	'interest' => array(
		...
		"category" 		=> __("faculty", "faculty"),
	    "show_settings_on_create" => false,
	    "icon" => get_stylesheet_directory_uri()."/img/vc_icons/interest.png",
	    "params" => array(
	        array(
	          "type" => "textfield",
	          "heading" => __("Widget title", "faculty"),
	...
	'licon' => array(
		...
		"category" 		=> __("faculty", "faculty"),
	    "show_settings_on_create" => false,
	    "icon" => get_stylesheet_directory_uri()."/img/vc_icons/licon.png",
	    "params" => array(
	        array(
	          "type" => "textfield",
	          "heading" => __("Widget title", "faculty"),
	...
	'single_icon' => array(
		...
		"base" => "vc_single_icon",
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/single-image.png",
		"category" 		=> __("faculty", "faculty"),
		"description" => __('Simple fontawesome icon', "faculty"),
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/ficon.png",
		"params" => array(
			array(
				"type" => "textfield",
				"heading" => __("Icon class", "faculty"),
	...
	'award' => array(
		...
		"category" 		=> __("faculty", "faculty"),
		"show_settings_on_create" => false,
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/award.png",
		"params" => array(
			array(
				"type" => "textfield",
				"heading" => __("Widget title", "faculty"),
	...
	'lab' => array(
		...
		"category" 		=> __("faculty", "faculty"),
		"show_settings_on_create" => false,
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/lab.png",
		"params" => array(
			array(
				"type" => "textfield",
				"heading" => __("Widget title", "faculty"),
	...
	'project' => array(
		...
		"category" 		=> __("faculty", "faculty"),
		"show_settings_on_create" => false,
		"icon" => get_stylesheet_directory_uri()."/img/vc_icons/project.png",
		"params" => array(
			array(
				"type" => "textfield",
				"heading" => __("Widget title", "faculty"),
